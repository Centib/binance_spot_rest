defmodule BinanceSpotRest.Endpoints.Trading.OrderCancelReplacePost.TakeProfitLimitTest do
  @moduledoc false
  ...
  alias BinanceSpotRest.Endpoints.Trading.OrderCancelReplacePost.TakeProfitLimitQuery
