defmodule BinanceSpotRest.Endpoints.Trading.OrderCancelReplacePost.TakeProfitTest do
  @moduledoc false
  ...
  alias BinanceSpotRest.Endpoints.Trading.OrderCancelReplacePost.TakeProfitQuery
