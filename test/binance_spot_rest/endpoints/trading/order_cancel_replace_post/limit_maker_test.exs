defmodule BinanceSpotRest.Endpoints.Trading.OrderCancelReplacePost.LimitMakerTest do
  @moduledoc false
  ...
  alias BinanceSpotRest.Endpoints.Trading.OrderCancelReplacePost.LimitMakerQuery
  ...
  describe "validation (required):" do
    @required [:symbol, :side, :quantity, :price, :cancelReplaceMode]
