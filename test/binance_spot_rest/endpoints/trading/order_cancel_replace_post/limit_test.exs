defmodule BinanceSpotRest.Endpoints.Trading.OrderCancelReplacePost.LimitTest do
  @moduledoc false
  ...
  alias BinanceSpotRest.Endpoints.Trading.OrderCancelReplacePost.LimitQuery
