defmodule BinanceSpotRest.Endpoints.Trading.OrderTestPost.TakeProfitLimitTest do
  @moduledoc false
  ...
  alias BinanceSpotRest.Endpoints.Trading.OrderTestPost.TakeProfitLimitQuery
