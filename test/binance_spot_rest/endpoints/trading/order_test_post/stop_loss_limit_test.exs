defmodule BinanceSpotRest.Endpoints.Trading.OrderTestPost.StopLossLimitTest do
  @moduledoc false
  ...
  alias BinanceSpotRest.Endpoints.Trading.OrderTestPost.StopLossLimitQuery
