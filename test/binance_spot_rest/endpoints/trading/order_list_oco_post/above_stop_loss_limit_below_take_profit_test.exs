defmodule BinanceSpotRest.Endpoints.Trading.OrderListOcoPost.AboveStopLossLimitBelowTakeProfitTest do
  @moduledoc false
  ...
  alias BinanceSpotRest.Endpoints.Trading.OrderListOcoPost.AboveStopLossLimitBelowTakeProfitQuery

  def full_valid_query do
    %AboveStopLossLimitBelowTakeProfitQuery{
  ...
  describe "validation (required):" do
    @required [:symbol, :side, :quantity, :aboveTimeInForce, :abovePrice]
