defmodule BinanceSpotRest.Endpoints.Trading.OrderListOtocoPost.WorkingLimitMakerPendingAboveTakeProfitLimitBelowStopLossLimitTest do
  @moduledoc false
  ...
  alias BinanceSpotRest.Endpoints.Trading.OrderListOtocoPost.WorkingLimitMakerPendingAboveTakeProfitLimitBelowStopLossLimitQuery

  def full_valid_query do
    %WorkingLimitMakerPendingAboveTakeProfitLimitBelowStopLossLimitQuery{
      ...
      pendingAboveType: BinanceSpotRest.Enums.OrderType._TAKE_PROFIT_LIMIT(),
  ...
  describe "validation (optional):" do
    ...
    test "valid without optional fields" do
      assert {:ok, %WorkingLimitMakerPendingAboveTakeProfitLimitBelowStopLossLimitQuery{}} =
               full_valid_query()
               ~>> Map.from_struct()
               ~>> Map.drop(@optional)
               ~>> then(
                 &struct(WorkingLimitMakerPendingAboveTakeProfitLimitBelowStopLossLimitQuery, &1)
               )
               ~>> BinanceSpotRest.Query.validate()
    end
  end
  ...
  describe "validation (type):" do
    @bad_types [
      ...
      pendingAbovePrice: "0.00129",
      pendingAboveIcebergQty: "0.5",
      pendingAboveType: :TAKE_PROFIT_LIMIT_INVALID,
