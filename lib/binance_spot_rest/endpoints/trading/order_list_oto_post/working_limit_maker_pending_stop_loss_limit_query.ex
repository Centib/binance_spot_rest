defmodule BinanceSpotRest.Endpoints.Trading.OrderListOtoPost.WorkingLimitMakerPendingStopLossLimitQuery do
  @moduledoc """
             Order List Oto (post) - Working limit maker pending stop loss limit query
  ...
  alias BinanceSpotRest.Endpoints.Trading.OrderPost.Shared.StopLossLimit, as: Pending
