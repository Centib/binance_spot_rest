defmodule BinanceSpotRest.Endpoints.Trading.OrderListOtoPost.WorkingLimitMakerPendingLimitQuery do
  @moduledoc """
             Order List Oto (post) - Working limit maker pending limit query
  ...
  alias BinanceSpotRest.Endpoints.Trading.OrderPost.Shared.Limit, as: Pending
