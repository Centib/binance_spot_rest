defmodule BinanceSpotRest.Endpoints.Trading.OrderListOtoPost.WorkingLimitPendingStopLossLimitQuery do
  @moduledoc """
             Order List Oto (post) - Working limit pending stop loss limit query
