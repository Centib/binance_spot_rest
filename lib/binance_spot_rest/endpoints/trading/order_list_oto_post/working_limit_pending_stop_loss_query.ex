defmodule BinanceSpotRest.Endpoints.Trading.OrderListOtoPost.WorkingLimitPendingStopLossQuery do
  @moduledoc """
             Order List Oto (post) - Working limit pending stop loss query
