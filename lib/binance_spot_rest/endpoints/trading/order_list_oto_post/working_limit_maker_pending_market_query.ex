defmodule BinanceSpotRest.Endpoints.Trading.OrderListOtoPost.WorkingLimitMakerPendingMarketQuery do
  @moduledoc """
             Order List Oto (post) - Working limit maker pending market query
