defmodule BinanceSpotRest.Endpoints.Trading.OrderListOtoPost.WorkingLimitPendingLimitMakerQuery do
  @moduledoc """
             Order List Oto (post) - Working limit pending limit maker query
