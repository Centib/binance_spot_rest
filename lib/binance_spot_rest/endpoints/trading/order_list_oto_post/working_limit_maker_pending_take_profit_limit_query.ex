defmodule BinanceSpotRest.Endpoints.Trading.OrderListOtoPost.WorkingLimitMakerPendingTakeProfitLimitQuery do
  @moduledoc """
             Order List Oto (post) - Working limit maker pending take profit query
