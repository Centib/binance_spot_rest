defmodule BinanceSpotRest.Endpoints.Trading.OrderListOcoPost.AboveLimitMakerBelowStopLossLimitQuery do
  @moduledoc """
             Order List Oco (post) - Above limit maker below stop loss limit query
