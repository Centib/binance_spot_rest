defmodule BinanceSpotRest.Endpoints.Trading.OrderListOcoPost.AboveStopLossLimitBelowTakeProfitQuery do
  @moduledoc """
             Order List Oco (post) - Above stop loss limit below take profit query
  ...
  alias BinanceSpotRest.Endpoints.Trading.OrderPost.Shared.TakeProfit, as: Below
