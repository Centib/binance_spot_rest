defmodule BinanceSpotRest.Endpoints.Trading.OrderListOcoPost.AboveStopLossBelowTakeProfitQuery do
  @moduledoc """
             Order List Oco (post) - Above stop loss below take profit query
