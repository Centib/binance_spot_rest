defmodule BinanceSpotRest.Endpoints.Trading.OrderListOcoPost.AboveTakeProfitLimitBelowStopLossLimitQuery do
  @moduledoc """
             Order List Oco (post) - Above take profit limit below stop loss limit query
