defmodule BinanceSpotRest.Endpoints.Trading.OrderListOcoPost.AboveStopLossLimitBelowTakeProfitLimitQuery do
  @moduledoc """
             Order List Oco (post) - Above stop loss limit below take profit limit query
