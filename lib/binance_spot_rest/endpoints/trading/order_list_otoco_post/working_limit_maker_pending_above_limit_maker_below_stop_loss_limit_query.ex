defmodule BinanceSpotRest.Endpoints.Trading.OrderListOtocoPost.WorkingLimitMakerPendingAboveLimitMakerBelowStopLossLimitQuery do
  @moduledoc """
             Order List Otoco (post) - Working limit maker pending above limit maker below stop loss limit query
