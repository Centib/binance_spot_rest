defmodule BinanceSpotRest.Endpoints.Trading.OrderListOtocoPost.WorkingLimitMakerPendingAboveTakeProfitBelowStopLossQuery do
  @moduledoc """
             Order List Otoco (post) - Working limit maker pending above take profit below stop loss query
