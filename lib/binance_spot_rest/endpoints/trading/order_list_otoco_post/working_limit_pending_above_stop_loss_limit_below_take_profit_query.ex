defmodule BinanceSpotRest.Endpoints.Trading.OrderListOtocoPost.WorkingLimitPendingAboveStopLossLimitBelowTakeProfitQuery do
  @moduledoc """
             Order List Otoco (post) - Working limit pending above stop loss limit below take profit query
