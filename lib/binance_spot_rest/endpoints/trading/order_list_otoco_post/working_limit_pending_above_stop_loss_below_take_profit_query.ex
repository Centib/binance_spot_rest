defmodule BinanceSpotRest.Endpoints.Trading.OrderListOtocoPost.WorkingLimitPendingAboveStopLossBelowTakeProfitQuery do
  @moduledoc """
             Order List Otoco (post) - Working limit pending above stop loss below take profit query
