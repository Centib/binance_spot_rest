defmodule BinanceSpotRest.Endpoints.Trading.OrderListOtocoPost.WorkingLimitPendingAboveStopLossBelowTakeProfitLimitQuery do
  @moduledoc """
             Order List Otoco (post) - Working limit pending above stop loss below take profit limit query
