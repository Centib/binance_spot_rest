defmodule BinanceSpotRest.Endpoints.Trading.OrderListOtocoPost.WorkingLimitMakerPendingAboveTakeProfitLimitBelowStopLossQuery do
  @moduledoc """
             Order List Otoco (post) - Working limit maker pending above take profit limit below stop loss query
