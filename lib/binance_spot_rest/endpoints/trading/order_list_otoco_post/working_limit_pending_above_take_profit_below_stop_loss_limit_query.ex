defmodule BinanceSpotRest.Endpoints.Trading.OrderListOtocoPost.WorkingLimitPendingAboveTakeProfitBelowStopLossLimitQuery do
  @moduledoc """
             Order List Otoco (post) - Working limit pending above take profit below stop loss limit query
